...
末尾の参考文献リストは著者名のアルファベット順でソートされるように設定しているため，本文中での引用は Harvard 方式を採用しています．
Vancouver 方式に変えても構いませんが，学位論文全体を通して一貫した引用方法を採用するようにしてください．
  ...
  #align(center)[
    #mytable2[
      #table(
        ...
        [コマンド], [`@Matsukawa:PoF2022,@Reynolds:PhilTransRoySoc1883`],
        [出力], [@Matsukawa:PoF2022,@Reynolds:PhilTransRoySoc1883],
        [コマンド], [`#citen(<Matsukawa:PoF2022>,<Reynolds:PhilTransRoySoc1883>)`],
        [出力], [#citen(<Matsukawa:PoF2022>,<Reynolds:PhilTransRoySoc1883>)],
        [コマンド], [`#citet(<Matsukawa:PoF2022>,<Reynolds:PhilTransRoySoc1883>)`],
        [出力], [#citet(<Matsukawa:PoF2022>,<Reynolds:PhilTransRoySoc1883>)],
        [コマンド], [`#citep(<Matsukawa:PoF2022>,<Reynolds:PhilTransRoySoc1883>)`],
        [出力], [#citep(<Matsukawa:PoF2022>,<Reynolds:PhilTransRoySoc1883>)],
        table.hline(),
      )
    ]
  ]
