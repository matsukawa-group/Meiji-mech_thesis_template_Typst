...
#block[]  // 字下げされてしまうのを防ぐのに使用
#heading(numbering: none, level: 2)[国際学術雑誌論文（査読あり）] <sec:app_journal>
...
#heading(numbering: none, level: 2)[国際学会講演（査読なし）]
<sec:app_kokusai>

- #underline[Meidai, T.] and Kikai, H., History of computational fluid dynamics, _22nd Meiji University Conference_ (MUC22), Tokyo (Japan), 23--26th Sep. (20xx), Talk xx, 5 pages, web page: <#link("https://xxxxxx")[xxxxxx]>.

#heading(numbering: none, level: 2)[国内学会講演（査読なし）]
<sec:app_kokunai>
